    ...
    skills: [
      ...
      },
      {
        ...
        resources: [
          ...
          { name: "Interactive Git Tutorial", url: "https://learngitbranching.js.org" }
        ]
      }
    ]
  },
    ...
    skills: [
      {
        ...
        completed: false,
        resources: [
          { name: "Cisco Networking Basics", url: "https://cisco.com" },
          { name: "Network Security Course", url: "https://coursera.org" }
        ]
      },
      {
        ...
        completed: false,
        resources: [
          { name: "SANS Incident Response", url: "https://sans.org" },
      ...
      },
      {
        ...
        description: "Identify and evaluate security risks",
        difficulty: "Intermediate",
        timeEstimate: "2-4 weeks",
        completed: false,
        resources: [
          { name: "ISO 27001 Guide", url: "https://iso.org" },
          { name: "Risk Management Course", url: "https://coursera.org" }
        ]
      }
    ]
  }
...
export default function Skills() {
  ...
  useEffect(() => {
    ...
    const roleData = skillsData[role] || skillsData["software-engineer"];
...
const completionPercentage =
  ...
  const roleData = skillsData[selectedRole] || skillsData["software-engineer"];
  ...
  return (
    <div className="min-h-screen bg-gray-900  py-12 px-4">
       <div className="flex px-10 py-5 justify-between items-center mb-12">
