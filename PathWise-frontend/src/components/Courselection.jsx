...
import { Search, ChevronDown, BookOpen, Expand } from 'lucide-react'; // Assuming you're using lucide-react for icons
    ...
    <div className="min-h-screen bg-gray-900 text-white relative overflow-hidden">
      <div className="pt-10 px-10">
          ...
          <div className="text-center mb-16">
            <div className='flex justify-center items-center ml-10'>
              <h2 className="text-[5rem] font-bold mb-2">
                Hello Bami <span className="inline-block animate-bounce">👋</span>
              </h2>
            </div>
        ...
        <div className="mt-20 mb-10">
          <h4 className="text-center text-white text-lg font-semibold text-gray-700 mb-6">Popular Courses</h4>
